...
- Do not commit machine-specific paths (e.g. `/home/<user>/…`, `~/.pi/agent/git/…`); use placeholders like `<checkout>` in docs instead. Placeholder notation is defined in the Notation section of [_docs/skill-distribution.md](_docs/skill-distribution.md).
