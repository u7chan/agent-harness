---
name: grilling
description: Challenge a plan or idea one question at a time and converge on the smallest sufficient design. Use when asked to grill an idea, brainstorm, or make a plan.
---
...
Grilling is a convergence process, not an exhaustive design exercise.
